      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <nav className="flex items-center text-lg text-slate-600">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2 py-1 rounded-md transition-colors ${!currentFolder
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2 bg-white hover:bg-slate-50 text-slate-700 rounded-xl flex items-center gap-2 transition-all duration-200 border border-slate-200 shadow-sm hover:shadow-md font-medium"
          >
            {/* Plus Icon */}
